...
import com.example.litechats.Adapters.AdapterTopPost;
...
public class HomeFragment extends Fragment {
    ...
    RecyclerView recyclerView, topPostsRecyclerview;
    List<ModelPost> postList;
    AdapterPosts adapterPosts;
    AdapterTopPost adapterTopPost;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //recycler view and its properties
        topPostsRecyclerview = view.findViewById(R.id.topPostsRecyclerview);
        LinearLayoutManager layoutManager1 = new LinearLayoutManager(getActivity());
        //show newest posts first, for this load from last
        layoutManager1.setStackFromEnd(true);
        layoutManager1.setReverseLayout(true);
        layoutManager1.setOrientation(RecyclerView.HORIZONTAL);// set horizontal

        //set layout to recyclerview
        recyclerView.setLayoutManager(layoutManager);
        topPostsRecyclerview.setLayoutManager(layoutManager1);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot ds : snapshot.getChildren()){
                    ...
                    //adapter
                    adapterTopPost=new AdapterTopPost(getActivity(), postList);
                    //set adapter to recyclerView
                    topPostsRecyclerview.setAdapter(adapterTopPost);
                }
            }
