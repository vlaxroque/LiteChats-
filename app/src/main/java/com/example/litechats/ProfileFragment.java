...
import com.example.litechats.Adapters.FollowingListActivity;
...
public class ProfileFragment extends Fragment {
    ...
    TextView followingListBtn;
    TextView changeProfilePictureBtn;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        postRecyclerView = view.findViewById(R.id.recyclerview_postsProfile);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot ds: snapshot.getChildren()){
                    ...
                    try {
                        ...
                        Picasso.get().load(R.drawable.ic_image).into(profileImage);
                    }
   ...
   /************************/
    ...
    private void showEditProfileDialog() {
        ...
        String options[]={"Edit Name", "Edit Phone", "Edit University", "Edit Course"};
        ...
        builder.setItems(options, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (which==0){
                    ...
                    progressDialog.setMessage("Updating university");
                    showInputDialog("university");

                }
                else if (which==3){
                    //edit phone clicked
                    progressDialog.setMessage("Updating course");
                    showInputDialog("course");
