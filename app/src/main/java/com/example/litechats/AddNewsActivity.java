...
public class AddNewsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageIV1 = findViewById(R.id.pImageIv1);
        ...
        if (isUpdateKey.equals("editPost")){
            actionBar.setTitle("Update News");
            uploadBtn.setText("Update");
            loadPostData(editPostId);
        }
        else {
            actionBar.setTitle("Add current News");
        ...
        uploadBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(title)){
                    Toast.makeText(AddNewsActivity.this, "Enter Title", Toast.LENGTH_SHORT).show();
                    return;
                }

                if (TextUtils.isEmpty(description)){
                    Toast.makeText(AddNewsActivity.this, "Enter description", Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        ref.child(editPostId)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        dialog.dismiss();
                        Toast.makeText(AddNewsActivity.this, "Successfully updated post", Toast.LENGTH_SHORT).show();
                        //reset views
                        titleEt.setText("");
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        dialog.dismiss();
                        Toast.makeText(AddNewsActivity.this, "[ERROR] : "+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
        ...
        mPictureRef.delete()
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        String filePathAndName = "News/"+"post_"+timeStamp;
                                ...
                                ref.child(timeStamp).setValue(hashMap)
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void unused) {
                                                //success in adding to database
                                                dialog.dismiss();
                                                Toast.makeText(AddNewsActivity.this, "Successfully published post", Toast.LENGTH_SHORT).show();
                                                //reset views
                                                titleEt.setText("");
                                                descriptionEt.setText("");
                                                imageIV.setImageURI(null);
