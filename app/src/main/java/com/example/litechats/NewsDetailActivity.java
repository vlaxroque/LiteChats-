...
public class NewsDetailActivity extends AppCompatActivity {
    ...
    private void loadComments() {
        ...
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("News").child(postId).child("Comments");
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if (id == 0){
                    ...
                    //edit is clicked
                    Intent intent = new Intent(NewsDetailActivity.this, AddPostActivity.class);
        ...
        picRef.delete()
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Query fquery = FirebaseDatabase.getInstance().getReference("News").orderByChild("pId").equalTo(postId);
                        fquery.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                ...
                                Toast.makeText(NewsDetailActivity.this, "Deleted successfully", Toast.LENGTH_SHORT).show();
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (mProcessLike){
                    ...
                    if (snapshot.child(postId).hasChild(myUid)){
                        ...
                        newsRef.child(postId).child("pLikes").setValue(""+(Integer.parseInt(pLikes)-1));
        ...
        ref.child(timestamp).setValue(hashMap)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        //added successfully
                        dialog.dismiss();
                        Toast.makeText(NewsDetailActivity.this, "Comment added successfully...", Toast.LENGTH_SHORT).show();
                        commentEt.setText("");
                        updateCommentCount();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        //failed to add
                        dialog.dismiss();
                        Toast.makeText(NewsDetailActivity.this, "Failed to upload comment\n"+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void updateCommentCount() {
        ...
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("News").child(postId);
    ...
    private void loadPostInfo() {
        ...
        fquery.addValueEventListener(new ValueEventListener() {
            ...
            @Override
            public void onCancelled(@NonNull  DatabaseError error) {
                Toast.makeText(NewsDetailActivity.this, "ERROR : "+error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public  void checkUserStatus(){
        ...
        if (user !=null){
            ...
            startActivity(new Intent(NewsDetailActivity.this, LoginAsActivity.class));
            finish();
        }
    }
